public class ListaCorrentistas {

    private Correntista[] itens;
    private int quantItens;

    public ListaCorrentistas() {
        itens = new Correntista[4];
        quantItens = 0;
    }
     ...
     */
    public void adicionarItem(Correntista item) {
    ...
    private void redimensionarArray() {
        // crio um novo array
        Correntista[] novoArray = new Correntista[this.itens.length * 2];
